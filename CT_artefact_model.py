...
if __name__ == '__main__':
    ...
    # Load the config
    config = get_config('CT_artefact_model')
    ...
    trial_dir = r"C:\Users\S.P.M. de Vette\OneDrive - UMCG\Desktop\pred_RT_results\CT_artefact_new/ResNet10" # config['general']['resultsCurrentDirectory']
