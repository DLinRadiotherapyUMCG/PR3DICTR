...
def window_reverse(windows, window_size, H, W, D):
    ...
    x = windows.view(B, H // window_size, W // window_size, window_size, D // window_size, window_size, window_size, -1)
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, attn_drop=0., proj_drop=0.,
        ...
        coords = torch.stack(torch.meshgrid([coords_h, coords_w, coords_d]))  # 2, Wh, Ww
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        shifted_x = window_reverse(attn_windows, self.window_size, H, W, D)  # B H' W' C
...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(self, config, n_features, img_size=96, patch_size=4, in_chans=3, num_classes=1000,
