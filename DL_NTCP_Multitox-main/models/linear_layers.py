...
class MultiToxOutputHead(torch.nn.Module):
    ...
    def __init__(self, config, n_features):
        ...
        self.clinical_variables_linear_units = config.clinical_variables_linear_units
        self.linear_units_endpoint = config.linear_units_endpoint
        self.clinical_variables_position = config.clinical_variables_position

        self.variance_logit_head = config.variance_logit_head
