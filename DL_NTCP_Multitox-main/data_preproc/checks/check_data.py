...
def main_save_structures_values():
    ...
    with open(os.path.join(data_prc_cfg.save_root_dir, data_prc_cfg.filename_structures_values_json), 'w') as f:
        json.dump(data_prc_cfg.structures_values, f, default=set_default)
...
def main_citor_dlc():
    ...
    data_dir_citor = data_prc_cfg.data_dir_citor
    data_dir_dlc = data_prc_cfg.data_dir_dlc
    save_dir_citor = data_prc_cfg.save_dir_citor
    logger = Logger(os.path.join(save_root_dir, data_prc_cfg.filename_check_data_logging_txt))
    start = time.time()
    ...
    with open(os.path.join(save_root_dir, data_prc_cfg.filename_patients_in_citor_and_dlc_txt), 'w') as f:
