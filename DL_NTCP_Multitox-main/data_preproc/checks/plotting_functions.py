...
def create_RTDOSE_cmap(name):
    ...
    if name == "HNC":
        ...
        HNC_color_mapping_dict = {              # NOTE: had to put this here 
            8400: (64,0,0),
            8050: (128,0,0),
            7700: (128,0,0),
            7490: (255,0,0),
...
def make_row_colorbar(
    ...
    pad = 0.01
    width = 0.01
    height_scalar = 0.9  # padding (between img and colorbar) and width for the colorbar
...
HNC_plotting_params = {
    ...
    "RTSTRUCT": {"color": "deeppink", "linewidth": 2, "alpha": 0.8, "cmap": "viridis"},
    "Attention": {
        "cmap": "Attention",
