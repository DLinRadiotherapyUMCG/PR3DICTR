...
def main():
    ...
    logger = Logger(os.path.join(save_root_dir, data_prc_cfg.filename_check_data_preproc_ct_segmentation_map_logging_txt))
    start = time.time()
    ...
    for _, d_i in zip(mode_list, data_dir_mode_list):
        ...
        df.to_csv(os.path.join(save_root_dir, data_prc_cfg.filename_cropping_regions_stats_csv), sep=';')
