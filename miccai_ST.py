...
if __name__ == '__main__':
    ...
    config['general']['experiment_name'] = 'Model_reproductions_2'
    config['general']['trialNumber'] = 'Hung_Xerostomia'
    ...
    #########################################################################################################
    # Load the config
    config = get_config('Daniel/uncertainty_models/Suzanne_Dysphagia')

    # Disable randomness
    set_random_seed(config['general']['seed'])

    config['general']['experiment_name'] = 'Model_reproductions_2'
    config['general']['trialNumber'] = 'Suzanne_Dysphagia'
