...
class DCNN_Pooling(torch.nn.Module):
    ...
    def __init__(self,
                 ...
                 conv_block_layers = 1,
                 pooling_size = 2,
                 normalization = 'batch',linear_units = [16]):
        ...
        self.output_head = output_head_def(n_features = 0, clinical_variables_linear_units = None, clinical_variables_dropout_p = None,
                            use_bias = False, lrelu_alpha = lrelu_alpha,dropout_p = dropout_p, clinical_variables_position = None,
