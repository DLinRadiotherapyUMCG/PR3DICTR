...
class EffNetV2(nn.Module):
    ...
    """
    def __init__(self, effnet_params, config,
...
def get_efficientnetv2(config, model_name, channels):
    ...
    if model_name == 'efficientnetv2_xs':
        ...
        model = efficientnetv2_s(config=config, channels=channels)
    elif model_name == 'efficientnetv2_m':
        model = efficientnetv2_m(config=config, channels=channels)
    elif model_name == 'efficientnetv2_l':
        model = efficientnetv2_l(config=config, channels=channels)
    elif model_name == 'efficientnetv2_xl':
        model = efficientnetv2_xl(config=config, channels=channels)
    else:
