...
def multi_softmargin_loss(config, outputs_dict, labels_dict):
    ...
    loss_function = torch.nn.MultiLabelSoftMarginLoss(reduction='none', pos_weight=torch.tensor(config['training']['loss']['weight'],  dtype=torch.float32, device=DEVICE))
