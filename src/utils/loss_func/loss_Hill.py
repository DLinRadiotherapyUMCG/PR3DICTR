...
def multi_HillLoss(config, outputs_dict, labels_dict):
    ...
    loss_function = Hill(reduction='none', pos_weight=torch.tensor(config['training']['loss']['weight'],  dtype=torch.float32))
